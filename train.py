...
def main(args):
    ...
    # print(r"C:\Users\14867\Downloads\FastSpeech2-main\{record_idx}\ckpt")
    # paths["checkpoint_path"] = Path(r"C:\Users\14867\Downloads\FastSpeech2-main\ckpt").resolve()
    # paths["synth_path"] = Path(r"C:\Users\14867\Downloads\FastSpeech2-main\synth").resolve()
    # paths["log_path"] = Path(r"C:\Users\14867\Downloads\FastSpeech2-main\log").resolve()
    # record_file_path = Path(record_root / "comments.txt").resolve()
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_dir", type=str, default="./processed/VCTK")
